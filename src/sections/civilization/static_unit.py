...
class StaticUnit(BaseStruct):
    @staticmethod
    def set_name_len(_, instance: StaticUnit):
        StaticUnit._name_aoe1.dtype.length = instance._len_name_aoe1
        StaticUnit._name_aoe2_swgb.dtype.length = instance._len_name_aoe2_swgb

    @staticmethod
    def sync_name_len(_, instance: StaticUnit):
        StaticUnit._name_aoe1.dtype.length = instance._len_name_aoe1 = len(instance._name_aoe1)
        StaticUnit._name_aoe2_swgb.dtype.length = instance._len_name_aoe2_swgb = len(instance._name_aoe2_swgb)

    @staticmethod
    def sync_ids(_, instance: StaticUnit):
    ...
    class_: int                              = Retriever(int16,                                                                default = 0)

    idle_sprite_id1: int                     = Retriever(int16,                                                                default = -1)
    idle_sprite_id2: int                     = Retriever(int16,          min_ver = Version((5, 7)),                            default = -1)
    ...
    required_clearance_radius_x: float       = Retriever(float32,                                                              default = 0.5)
    required_clearance_radius_y: float       = Retriever(float32,                                                              default = 0.5)
    ...
    selection_radius_x: float                = Retriever(float32,                                                              default = 0.5)
    selection_radius_y: float                = Retriever(float32,                                                              default = 0.5)
    ...
    wwise_train_sound_id: int                = Retriever(uint32,         min_ver = Version((7, 1)),                            default = -1)
    wwise_damage_sound_id: int               = Retriever(uint32,         min_ver = Version((7, 1)),                            default = -1)
    wwise_selection_sound_id: int            = Retriever(uint32,         min_ver = Version((7, 1)),                            default = -1)
    wwise_dying_sound_id: int                = Retriever(uint32,         min_ver = Version((7, 1)),                            default = -1)
    ...
    unit_line_id: int                        = Retriever(int16,          min_ver = Version((5, 9)), max_ver = Version((5, 9)), default = 0)
    min_tech_level: int                      = Retriever(int8,           min_ver = Version((5, 9)), max_ver = Version((5, 9)), default = 0)
