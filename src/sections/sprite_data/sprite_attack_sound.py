...
class SpriteAttackSound(BaseStruct):
    ...
    sound_delay2: int    = Retriever(int16,  min_ver = Version((7, 1)), default = 0)
    sound_id2: int       = Retriever(int16,  min_ver = Version((7, 1)), default = 0)
    wwise_sound_id2: int = Retriever(uint32, min_ver = Version((7, 1)), default = 0)
    sound_delay3: int    = Retriever(int16,  min_ver = Version((7, 1)), default = 0)
    sound_id3: int       = Retriever(int16,  min_ver = Version((7, 1)), default = 0)
