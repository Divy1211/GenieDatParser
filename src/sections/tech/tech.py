...
from bfp_rs.types.le import i16, bool8, Array, u16, u32, i8, i32, Bytes, str16
...
class Tech(BaseStruct):
    ...
    full_tech_tree_mode: int                        = Retriever(i16,                min_ver = Version(5, 7),                          default = True)
    ...
    button_id: int                                  = Retriever(i8,                                                                   default = 0)
