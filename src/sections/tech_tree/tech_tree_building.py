...
class TechTreeBuilding(BaseStruct):
    ...
    location_in_age: int                           = Retriever(i8,                                                                                            default = 0)
    """aka level_no"""

    total_children_by_age: list[int]               = Retriever(Array[5][i8],                                                                                  default_factory = lambda _ver: [0] * 3)
    initial_children_by_age: list[int]             = Retriever(Array[5][i8],                                                                                  default_factory = lambda _ver: [0] * 3)
